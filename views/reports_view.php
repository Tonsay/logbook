...
<body>
    ...
    <div class="main-content" id="mainContent">
        ...
        <div style="display: flex; flex-direction: row; flex-wrap: wrap; gap: 25px; align-items: stretch; margin-top: 20px;">
            ...
            <div style="width: 100%; background: linear-gradient(135deg, #1e293b 0%, #0f172a 100%); padding: 30px; border-radius: 16px; border: 1px solid rgba(0, 165, 239, 0.3); text-align: center; box-shadow: 0 10px 15px -3px rgba(0, 0, 0, 0.5); display: flex; flex-direction: column; justify-content: center;">
                <h3 style="margin: 0; color: #b9e6ff; font-size: 14px; text-transform: uppercase; letter-spacing: 1px;">
                    Total Documents <?php echo empty($current_year) ? '(All Time)' : "($current_year)"; ?>
                </h3>
                <p style="margin: 15px 0 0 0; color: #10b981; font-size: 64px; font-weight: bold; line-height: 1;">
            ...
            <?php if (!empty($category_counts)): ?>
                <?php foreach ($category_counts as $cat_name => $count): ?>
                    <div style="flex: 1; min-width: 200px; background: #1e293b; padding: 25px; border-radius: 12px; border: 1px solid rgba(255,255,255,0.05); text-align: center; box-shadow: 0 4px 6px rgba(0,0,0,0.2); transition: transform 0.2s; display: flex; flex-direction: column; justify-content: center;">
                        <h3 style="margin: 0; color: #aaa; font-size: 13px; text-transform: uppercase; letter-spacing: 0.5px;">
